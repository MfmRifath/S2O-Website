  ...
  return (
    <nav className="sidebar2 d-flex flex-column p-3">
      ...
      <Link
        to="/adminReports"
        className={`nav-link1 ${
          location.pathname === "/adminReports" ? "active" : ""
        }`}
      >
      ...
      <Link
        to="/adminAnalytics"
        className={`nav-link1 ${
          location.pathname === "/adminAnalytics" ? "active" : ""
        }`}
      >
      ...
      <div className="nav-item dropdown">
        <a
          className={`nav-link1 dropdown-toggle ${
            location.pathname.startsWith("/adminSettings") ? "active" : ""
          }`}
          href="#"
          id="settingsDropdown"
          role="button"
        ...
        >
          <li>
            <Link
              ...
              className={`dropdown-item ${
                location.pathname === "/adminSettings/site" ? "active" : ""
              }`}
            >
              Site Settings
            </Link>
          ...
          <li>
            <Link
              to="/securitySettings"
              className={`dropdown-item ${
                location.pathname === "/adminSettings/security" ? "active" : ""
              }`}
            >
              Security Settings
            </Link>
      ...
      <Link
        ...
        className={`nav-link1 ${
          location.pathname === "/adminDonationManagment" ? "active" : ""
        }`}
      >
